                    ...
                    <div class="product_img_slide owl-carousel">
                        @for ($i = 0; $i < count($images); $i++)
                            <div class="single_product_img">
                                <img src="{{ asset('storage/item/' . $images[$i]['image'] . '') }}" class="img-fluid">
                            </div>
                        @endfor
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="single_product_text text-center">
                        ...
                        <p>
                            {{ Storage::disk('public')->get('deskripsi/' . $dataitem[0]->code . '.txt') }}
                        </p>
                        @if ($dataitem[0]->status == 0)
                        <div class="alert alert-danger">
                            Item sedang tidak tersedia
                        </div>
                        @else
                        ...
                        <div class="alert alert-warning">
                            Alamat IP Anda <strong> {{ Request::ip() }} </strong>. Alamat IP Anda Tidak Kami Simpan
                            Sampai
                            Anda
                            Melakukan Pemesanan.
                        </div>
