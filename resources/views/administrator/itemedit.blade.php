                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-4">
                                            ...
                                            <select class="form-control" name="diskonstate" id="diskonstate">
                                                <option value="1"
                                                    {{ $dataitem[0]->diskonstate == 1 ? 'selected' : null }}>
                                                    Ya
                                                </option>
                                                <option value="0"
                                                    {{ $dataitem[0]->diskonstate == 0 ? 'selected' : null }}>
                                                    Tidak
                                                </option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            ...
                                            <textarea required name="deskripsi" id="deskripsi" cols="30" rows="10"
                                                class="form-control">{{ Storage::disk('public')->get('deskripsi/' . $dataitem[0]->code . '.txt') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
